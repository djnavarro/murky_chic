...
genuary_tree <- function(seed) {
  ...
  version <- "03"
  fname <- paste0("murktree_", version, "_", seed, ".jpg")

  set.seed(seed)
  shades <- c("#666a67", "#23424c", "#2F3D00", "#FFFFFF") # force murky chic
  bgcolr <- blend(shades[1], "black")
  dtcolr <- blend(shades[length(shades)], "white")
