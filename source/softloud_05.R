...
if(scheme == 3) {
  ...
  nshades <- 3
  gr <- .015
  pal <- c(blend("#666a67", "white"), "#23424c", "#2F3D00", "white")
  bg <- blend("#666a67", "white")
}
...
if(scheme == 7) {
  #pal <- scico::scico(4, palette = "grayC"); 
  iter <- 100000
  pal <- c(blend("#666a67", "white"), "#2F3D00", "#23424c", "white")
  bg <- blend("#666a67", "white")
} # <- slooooow
if(scheme == 8) {runif(1); pl <- "scico::bamako"; ex <- -.0004; rd <- .001; f <- .5}
if(scheme == 9) {
  pal <- scico::scico(4, palette = "lajolla"); 
  iter <- 100000
  pal <- c(blend("#666a67", "white"), "#2F3D00", "#23424c", "white")
  bg <- blend("#666a67", "white")
} # <- slooooow
...
if(is.null(pal)) {
  pal <- paletteer::paletteer_c(palette = pl, n = nshades)
  pal <- adjust(pal)
}
filter_x <- c(-f, f)
filter_y <- c(-f, f)
